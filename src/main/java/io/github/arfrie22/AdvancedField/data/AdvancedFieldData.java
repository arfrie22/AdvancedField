package io.github.arfrie22.AdvancedField.data;
...
public class AdvancedFieldData extends ComplexData<AdvancedFieldData> {
  ...
  public AdvancedFieldData(SimplePose2d robot, Map<String, SimplePose2d[]> objects) {
    this.robot = robot;
    this.objects = objects;
  }

  @SuppressWarnings("JavadocMethod")
  public AdvancedFieldData(Map<String, Object> map) {
