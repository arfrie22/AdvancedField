package io.github.arfrie22.AdvancedField.widget;
...
@Description(name = "Advanced Field", dataTypes = AdvancedFieldData.class)
@SuppressWarnings({"EmptyCatchBlock", "PMD.TooManyFields"})
@ParametrizedController("AdvancedFieldWidget.fxml")
public class AdvancedFieldWidget extends SimpleAnnotatedWidget<AdvancedFieldData> {
  @FXML
  private Pane root;
  ...
  private Map<String, AdvancedFieldData.SimplePose2d[]> previousObjects = new HashMap<>();
  ...
  private void updateObjects(boolean forceUpdateObjects) {
    ...
    for (Map.Entry<String, AdvancedFieldData.SimplePose2d[]> entry : dataOrDefault.get().getObjects().entrySet()) {
